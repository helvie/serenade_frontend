...
export default function CardMessageContainer(props) {
    ...
    const navigateToMessageContent = () => {
        navigation.navigate('ChatScreen');
    };

    return (
        <TouchableOpacity onPress={navigateToMessageContent}>
            <View style={styles.container}>
                ...
                <View style={styles.iconContainer}>
                    <Text style={[styles.secondText, { marginRight: 30, marginTop: 5, textAlign: 'right' }]}>
                        {props.time}
                    </Text>
                </View>
            </View>
